    ...
    <div class="profile">
        <div class="container">
            <el-card class="profile-card">
                ...
                <el-tabs v-model="activeTab" @tab-click="handleTabEvent">
                    <!-- 基本信息 -->
                                ...
                                <el-card v-for="address in addresses" :key="address.id" class="address-item">
                                    <div class="address-content">
                                        <div class="info">
                                            ...
                                            <el-tag v-if="address.isMainAddr" size="small" type="success">
        ...
        >
            ...
            >
                ...
                <el-form-item :label="t('user.phone')" prop="phone">
                    <el-input v-model="addressForm.contactDetail"/>
                </el-form-item>
                <el-form-item :label="t('user.address')" prop="address">
                    <el-input v-model="addressForm.addr" type="textarea" :rows="3"/>
                </el-form-item>
                <el-form-item>
                    <el-checkbox v-model="addressForm.isMainAddr">
...
/**
 * 切换标签页的事件（就是地址，个人信息，修改密码操作啥的）
 * @param tab
 */
const handleTabEvent = (tab) => {
    if (tab.paneName === "address") {
        fetchAddresses()
    }
    if (tab.paneName === "password"){}
    if (tab.paneName === "basic") {
        fetchUserInfo()
    }
}
